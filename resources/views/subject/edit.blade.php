                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control form-contol-sm" value="{{ old('name',$subject->name) }}" />
                            ...
                            <div class="col-sm-2" style="margin-top:38px;">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox small">
                                        <input type="checkbox" class="custom-control-input" id="isClassroomCheck" name="is_classroom" value="checked" {{ old('is_classroom') != 'checked' && $subject->classroom_id ==''?'' :'checked' }} />
                            ...
                            <div class="col-sm-4 classroomIdCol" style="display: {{ old('is_classroom') != 'checked' && $subject->classroom_id ==''?'none' :'' }} ">

                                <div class="form-group">
                                    
                                    <label for="Classroom">Classroom</label>

                                    <select name="classroom_id[]" id="classroom_id" class="form-control form-control-sm select2" multiple>
