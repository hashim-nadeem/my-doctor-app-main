                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="district_id" id="district_id" class="form-control form-contol-sm select2">
                                        ...
                                        @forelse ($districts as $district)
                                            ...
                                            <option value="{{ $district->id }}" {{ old('district_id',$campus->district_id) == $district->id?'selected':'' }}>{{ $district->name }}</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control form-contol-sm" value="{{ old('name',$campus->name) }}" />
